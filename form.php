...
<link rel="stylesheet" href="payment/css/bootstrap-side-notes.css" />
<style type="text/css">
.col-centered {
...
<script type="text/javascript">
            ...
            Stripe.setPublishableKey('pk_test_9yeuCub6Rqr7RlYrRdPwyQTk');
...
<form action="" method="POST" id="payment-form" class="form-horizontal">
  ...
  <div class="page-header">
    <h2 class="gdfg" style="display:inline-block;float:left">Secure Payment Form</h2>
	<img src="assets/img/big@2x.png" width="200px"  alt="Powered By Stripe" style="display:inline-block;float:left;margin-left:30px;margin-top:10px">
...
if ($_POST) {
  Stripe::setApiKey("sk_test_aeZ2gMZkHRBOV6veBxAo8eJw");
  $error = '';
  $success = '';
  ...
  try {
    ...
    Stripe_Charge::create(array("amount" => $_POST['amount']*100,
                                "currency" => "usd",
...
echo "connection was not established".mysqli_connect_error();
  ...
  busstop varchar(80) NOT NULL,
  stopcode varchar(8) NOT NULL
...
if (!$result) {
  die("Invalid query: " . mysql_error());
    ...
    $personname = $_POST['cardholdername'];
	$email = $_POST['email'];
	$busstopname = $_GET['name'];
	$busstopcode = $_GET['code'];
	$amountdonated = $_POST['amount'];

    $sql1= "INSERT INTO donations VALUES(0,'$personname','$email','$amountdonated','$busstopname','$busstopcode')";
...
?>
  ...
  if(isset($_GET['name'])) {
   ...
   echo  '<label class="col-sm-4 control-label" for="textinput">BUSSTOP</label>';
   echo '<div class="col-sm-6">';
   echo '<span class="col-sm-4" style="margin-left:-10px; margin-top:5px; width:500px;align:left;font-weight:bold;font-size:18px">'.$n.'</span>';
   echo '</div>';
   echo '</div>';
  }
   ?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" name="amount" placeholder="Amount" class="amount form-control">
    </div>
  </div>
  </fieldset>
  <fieldset>
